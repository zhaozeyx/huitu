 ...
 * @author zhaozeyang
 */
class PullToRefreshWrapper<T : ListView>
/**
 * 构造方法
...
(context: Context, attrs: AttributeSet) : FrameLayout(context, attrs) {
    ...
    fun initView() {
        val contentView = LayoutInflater.from(context)
                .inflate(R.layout.pull_refresh_container, null)
        ...
        refreshLayout!!.addView(mListView)
    ...
    private fun setListParam() {
        ...
        mListView!!.setOnScrollListener(object : OnScrollListener {
            ...
            override fun onScroll(view: AbsListView, firstVisibleItem: Int,
                ...
                -mListView!!.footerViewsCount
                -mListView!!.headerViewsCount
